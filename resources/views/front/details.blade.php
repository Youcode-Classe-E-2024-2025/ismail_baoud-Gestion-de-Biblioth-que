<div class="font-[sans-serif] p-4 bg-gray-100">
    <div class="lg:max-w-6xl max-w-xl mx-auto">
      <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-12 max-sm:gap-8">
        ...
        <div class="w-full">
          <div>
            <h3 class="text-lg sm:text-xl font-bold text-gray-800">SunProtect Sunscreen SPF</h3>
            ...
            <div class="mt-2">
              <p class="text-gray-500 mt-1 text-sm">Contains Vitamin E and Green Tea Extract to protect, nourish, and
                hydrate the skin while providing antioxidant benefits to combat free radicals and promote a healthy
                complexion.</p>
            </div>
  
            <div class="flex items-center flex-wrap gap-2 mt-4">
              <p class="text-gray-500 text-base"><strike>$16</strike></p>
              <h4 class="text-purple-800 text-2xl sm:text-3xl font-bold">$12</h4>
            ...
            <div>
              <h4 class="text-base mt-4 text-gray-500 font-semibold">Net Wt: 100G</h4>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="mt-4 flex flex-wrap gap-4">
              <button type="button"
                ...
                to cart</button>
              <button type="button"
                class="px-4 py-3 w-[45%] border border-purple-600 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold">Buy
                it now</button>
            </div>
          </div>
          ...
          <div>
            ...
            <div class='flex items-center gap-2 mt-4 max-w-sm'>
              ...
              <button type='button'
                class='border border-purple-600 outline-none bg-purple-600 hover:bg-purple-700 text-white  px-4 py-2.5 text-sm'>Apply</button>
            </div>
          </div>
